# DISCLAIMER: Recovery code was written by eboda. and can be found here:
...
if __name__ == "__main__":
    ...
    # Read 625 values from the file
    with open("mersenneCookies.txt","r") as input:
    ...
    # Generate next 50 values and print them
    for i in range(50):
        print(int(result.getrandbits(32)))